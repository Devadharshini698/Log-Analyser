...
with st.sidebar:
    ...
    <div style="font-size: 0.8rem; color: {GRAY};">
        ...
        <p style="margin-top:10px;"><b style="color:{WHITE};">High-Impact Features</b></p>
        <p style="color:{SANDISK_RED};">1. Failure DNA Fingerprint</p>
        <p style="color:{PSG_LIGHT};">2. Git Blame Auto-Assignee</p>
        <p style="color:#F59E0B;">3. Regression Trend Timeline</p>
        <p style="color:#10B981;">4. Noise Confidence Scoring</p>
        <p style="color:#E879F9;">5. Fix Verification Loop</p>
        <p style="color:#38BDF8;">6. Cross-Project Memory</p>
    </div>
    """)

    st.markdown("---")
    render_custom_card(f"""
    <div style="font-size: 0.75rem; color: {GRAY_DIM}; text-align:center;">
